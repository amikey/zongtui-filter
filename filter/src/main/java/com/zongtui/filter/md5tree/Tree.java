 ...
 */
public class Tree<C extends CharSequence> {
     ...
     */
    public Tree(INodeCreator creator) {
    ...
    protected static class TreePrinter {
        ...
        public static <C extends CharSequence> void print(Tree<C> tree) {
            System.out.println(getString(tree));
        }

        public static <C extends CharSequence> String getString(Tree<C> tree) {
